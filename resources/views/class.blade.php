        ...
        <section class="container">
            <div class="row mt-4">
                <div class="col-lg-9" id="class_running">
                    @if(isset($first_class))
                        ...
                        <div id="video" class="col-md-12">
                            <iframe src="https://www.youtube.com/embed/{{$first_class->link_class}}" frameborder="0" class="video_class" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    @else
                ...
                <div class="col-lg-3">
                    ...
                    @endif
                    <div class="list-aulas" style="height:60vh;margin-top:20%;">
                        @if(isset($workshops))
                        @foreach($workshops as $oficina)
                        <details>
                            <summary class="title d-flex justify-content-between">{{$oficina->name}}
                                @if(Auth::user()->status != 'Aluno')
                                    <div class="d-flex">
